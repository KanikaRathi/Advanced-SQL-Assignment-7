...
VALUES (1, 'Keyboard', 'Electronics', 1200),
...
INSERT INTO Sales 
VALUES(1, 1, 4, '2024-01-05'),
(2, 2, 10, '2024-01-06'),
(3, 3, 2, '2024-01-10'),
(4, 4, 1, '2024-01-11');

##6.Write a CTE to calculate the total revenue for each product (Revenues = Price × Quantity), and return only products where  revenue > 3000.
...
BEGIN
    ...
    VALUES
    (OLD.ProductID, OLD.ProductName, OLD.Category, OLD.Price, CURDATE());
END //
